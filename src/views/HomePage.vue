    ...
    <section class="bg-gray-100 py-12 mt-16">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="bg-gradient-to-r from-green-400 to-blue-500 p-8 text-white rounded-lg shadow-lg">
          ...
          <router-link to="/products" class="inline-block mt-6 bg-white text-green-600 font-bold px-6 py-2 rounded-lg">Shop Now</router-link>
        </div>
        <div class="bg-gradient-to-r from-yellow-400 to-red-500 p-8 text-white rounded-lg shadow-lg">
          ...
          <router-link to="/products" class="inline-block mt-6 bg-white text-red-600 font-bold px-6 py-2 rounded-lg">Explore Now</router-link>
        </div>
      </div>
    </section>
  </div>
